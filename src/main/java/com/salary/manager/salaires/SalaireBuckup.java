...
@Entity
public class SalaireBuckup {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	private int salaireBuckupId;
	...
	public SalaireBuckup() {
		super();
	}
	public SalaireBuckup(SalaireBuckup salaire) {
		super();
		this.salaireBuckupId = salaire.getSalaireBuckupId();
	...
	public void setSalaireBuckupId(int salaireBuckupId) {
		this.salaireBuckupId = salaireBuckupId;
	}
