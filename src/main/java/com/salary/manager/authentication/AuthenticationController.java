 ...
 * 
 * import com.salary.manager.security.jwt.model.AuthenticationRequest; import
 * com.salary.manager.security.jwt.model.AuthenticationResponse; import
 * com.salary.manager.security.jwt.util.JwtTokenUtil; import
 * com.salary.manager.user.User; import com.salary.manager.user.UserService;
 * 
 * @RestController
 * 
 ...
 * 
 * @Autowired private UserService userDetailsServices;
 * 
 ...
 * ResponseEntity.ok(userDetailsServices.save(user)); }
 * 
